                    ...
                    @foreach ($product as $index => $item)
                        <tr>
                            ...
                            <td style="display: flex">
                                <a class="btn btn-sm btn-primary m-1" href="/products-edit/{{ $item->id }}"><i class="fa fa-pencil-square-o"
                                        aria-hidden="true"></i></a>
                                <a class="btn btn-sm btn-danger m-1" href="/products-delete/{{ $item->id }}"><i class="fa fa-trash"
                                        aria-hidden="true"></i></a>
                            </td>
                        </tr>
                    @endforeach
