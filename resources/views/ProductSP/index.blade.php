...
@section('content')
    <div class="card card-table-two">
        <div class="d-flex justify-content-between">
            ...
            <a href="/add-specification" class="btn btn-sm btn-primary">Add new</a>
                ...
                <tbody>
                    @foreach ($ProductSP ?? '' as $index => $item)
                        <tr>
                            ...
                            <td class=" tx-medium tx-inverse">{{ $item->unit }}</td>
                            <td class=" tx-medium tx-inverse">
                                <a href="/edit-specification/{{ $item->id }}" class="btn btn-sm btn-primary">Edit</a>
